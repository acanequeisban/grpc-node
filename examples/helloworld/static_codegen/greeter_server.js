...
var localhost_cert = new Buffer.from(fs.readFileSync(__dirname +  '/credentials/localhosttest.crt','base64')); 
var localhost_key = new Buffer.from(fs.readFileSync(__dirname +  '/credentials/localhosttest.key','base64')); 
...
function main() {
  ...
  localhost_key = new Buffer (localhost_key,"binary");
